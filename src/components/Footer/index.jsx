        ...
        <footer className="footer-wrap">
            ...
            <div className="footer-content">
                <ul className="socials">
                    <li><a href="https://www.fb.com/josenicoleno"><i className="fa fa-facebook"></i></a></li>
                    <li><a href="https://www.instagram.com/jose.nicoleno/"><i className="fa fa-instagram"></i></a></li>
                    <li><a href="https://www.linkedin.com/in/jose-nicoleno/"><i className="fa fa-linkedin"></i></a></li>
                    <li><a href="https://github.com/josenicoleno"><i className="fa fa-github"></i></a></li>
                </ul>
                <h3>José Nicoleno</h3>
